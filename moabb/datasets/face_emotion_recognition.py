...
class FER(BaseDataset):
    ...
    def __init__(self, BIDS_path, subjects=None):
        ...
        eeg_files = self.layout.get(return_type='fir', datatype='eeg', suffix='eeg', extension='edf', run='1')
        ...
        super().__init__(
            ...
            events={emo:i for i, emo in enumerate(["sad", "happy", "neutral", "fear", "angry", "disgust"])},
            code="FaceEmotionRecognition",
            interval=[0, 4],
            paradigm="emotion",
            doi="",
        )
